...
- **CSV-import:** kontaktok/adatok tömeges bevitele meglévő Excel/Sheet listákból.
- **Értesítési rendszer:** app-on belüli + e-mail emlékeztetők (határidők, események).
