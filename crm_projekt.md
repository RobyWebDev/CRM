...
**Laravel-projekt gyors elindításához előkészítve (Laragon telepítése után azonnal használható):** csomag-/függőségterv [`docs/csomag-terv.md`](docs/csomag-terv.md), mappastruktúra + kész artisan-parancsok [`docs/mappastruktura-terv.md`](docs/mappastruktura-terv.md), kezdő adatok seeder-terve [`docs/seeder-terv.md`](docs/seeder-terv.md).
