...
12d. **Ügyfélszerzés-terv:** [`ugyfelszerzes-terv.md`](ugyfelszerzes-terv.md) — MiniCRM + Salesforce bevált ügyfélszerzési mintái (ajánlói/partnerprogram, kampány-attribúció), nem túl távoli prioritással.
